    ...
    function() {
        $(function() {
            ...
            u = i.find("a.next").show(), a = i.find("a.previous").show(), O = function() {
                var e, t, n;
                return n = c.width(), e = s.width(), t = (n - e) / 2, u.css({
                    left: Math.floor(s.outerWidth() + t)
                }), a.css({
                    width: Math.floor(t)
                })
            ...
            }, k = window.environment.isMobile() ? 0 : 1, window.forceSlideIndex != null && (k = window.forceSlideIndex), A = function(t, n, r) {
                var i;
                x(r), N(r);
            ...
            return $(".hero nav").addClass("animatable"), setTimeout(function(e) {
                return function() {
                    var e;
                    return e = ["/images/img-alluser.png", "/images/img-crossplatform.png", "/images/img-notification.png"], window.preload(e)
                }
            }(this), 2e3)
        })
    }.call(this);